...
<ul class="sidebar-menu">
    ...
    <li>
        <a href="<?php echo site_url('member/users');?>">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo site_url('member/posts');?>"><i class="fa fa-circle-o"></i> Posts</a></li>
            <li><a href="<?php echo site_url('member/categories');?>"><i class="fa fa-circle-o"></i> Categories</a></li>
